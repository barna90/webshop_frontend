(function($) {
    ...
    function siteToggleAction() {
        ...
        $('.ps-cart-toggle').on('click', function(e) {
            e.preventDefault();
            cartSidebar.addClass('active');
            $('.ps-site-overlay').addClass('active');
        });
        $('.navigation--sidebar .navigation__header .ps-btn--close').on('click', function(e) {
            e.preventDefault();
            navSidebar.removeClass('active');
            $('.ps-site-overlay').removeClass('active');
        });
        $('.ps-cart--sidebar .ps-cart__header .ps-btn--close').on('click', function(e) {
            e.preventDefault();
        ...
        $('body').on("click", function(e) {
            if ($(e.target).siblings(".navigation--sidebar").hasClass('active')) {
                navSidebar.removeClass('active');
                $('.ps-site-overlay').removeClass('active');
            }
            if ($(e.target).siblings(".ps-cart--sidebar").hasClass('active')) {
                cartSidebar.removeClass('active');
                $('.ps-site-overlay').removeClass('active');
            }
            if ($(e.target).siblings(".ps-filter--sidebar").hasClass('active')) {
                filterSidebar.removeClass('active');
                $('.ps-site-overlay').removeClass('active');
            }
        });
    ...
    function hotPotPointLocation() {
        $('.ps-hotpot__point').each(function() {
            var $this = $(this),
                dataX = $this.data('x'),
                dataY = $this.data('y');
            $this.css({
        ...
        $('.ps-hotpot__point').on('click', function(e) {
            e.preventDefault();
            $(this).toggleClass('active');
        })
    }
